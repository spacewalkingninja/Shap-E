...
call conda install pytorch==2.0.1 torchvision==0.15.2 pytorch-cuda=11.7 -c pytorch -c nvidia -y
call conda install git -y
call conda install conda-forge::transformers -y
